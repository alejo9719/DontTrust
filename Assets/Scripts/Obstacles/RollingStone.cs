	...
	public class RollingStone : ObstacleClass {
		...
		public void OnCollisionEnter(Collision col)
		{
			if (col.gameObject.CompareTag ("Player") && m_MakeDamage) {
				...
				sbyte damage = (sbyte)(int)Mathf.Abs(m_Rigidbody.velocity.magnitude*m_DamageMultiplier); //Damage will be dealt according to velocity of the stone //DEBE SER RELATIVO A LA DIRECCION RESPECTO A JUGADOR
